  ...
  <footer class="bg-gray-900 text-white">
    <div class="container mx-auto px-4 py-12">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          <h3 class="text-2xl font-bold text-electric-500 mb-4">Sole Street</h3>
          <p class="text-gray-400">Premium sneakers and streetwear for the modern urban lifestyle.</p>
        </div>
      ...
      <div class="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
        <p>&copy; {{ new Date().getFullYear() }} Sole Street. All rights reserved.</p>
      </div>
    </div>
  </footer>
</template> 